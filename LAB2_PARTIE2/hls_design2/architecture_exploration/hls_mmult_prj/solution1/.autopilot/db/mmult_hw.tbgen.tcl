...
set C_modelArgList {
	{ a int 16 regular {array 2500 { 1 3 } 1 1 }  }
	{ b int 16 regular {array 2500 { 1 3 } 1 1 }  }
	{ out_r int 16 regular {array 2500 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "a","cData": "half","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "b","cData": "half","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1380101", "EstimateLatencyMax" : "1380101",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1380101", "Max" : "1380101"}
	, {"Name" : "Interval", "Min" : "1380102", "Max" : "1380102"}
]}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 12 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 16 } } }
	b { ap_memory {  { b_address0 mem_address 1 12 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 16 } } }
